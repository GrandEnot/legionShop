(function(){
  ...
  const productsData = [
    ...
    {category:"Ударная экипировка", subcategory:"Защита корпуса и ног", name:"Защита голени (эргономичные)", brandModel:"Top King Pro", sizes:"S,M,L,XL", price:9500, desc:"Эргономичные щитки с приподнятым гребнем для полной защиты. Легкие, с неопреновым соединением для гибкости. Натуральная кожа.", image:"imgprotection//topking-pro.png"},
    ...
    {category:"Борцовская экипировка", subcategory:"Кимоно и рашгарды", name:"Кимоно джиу-джитсу (белое/син)", brandModel:"Manto Basic", sizes:"A0,A1,A2,A3,A4", price:13900, desc:"Легкое кимоно Manto Basic 2.0. Куртка 400 GSM pearl weave, штаны 10 oz twill. Прорезиненный воротник.", image:"img/struggle/manto-basic1.png"},
    ...
    {category:"Борцовская экипировка", subcategory:"Кимоно и рашгарды", name:"Рашгард", brandModel:"Manto", sizes:"S,M,L,XL", price:5200, desc:"Компрессионный рашгард Manto. Плоские швы, отводит влагу, не сковывает движения.", image:"imgstruggle//manto-rashguard.png"},
