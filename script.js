(function(){
  ...
  // ===================== ДАННЫЕ ТОВАРОВ =====================
  const productsData = [
    {category:"Ударная экипировка", subcategory:"Перчатки", name:"Перчатки боксерские / муай-тай", brandModel:"Fairtex BGV1", sizes:"10,12,14,16 oz", price:12900, desc:"Эргономичные перчатки из премиальной кожи с уникальной контурной посадкой. Трехслойная пена Fairtex обеспечивает отличную защиту кисти и костяшек. Идеальны для спаррингов и работы на мешках.", image:"img/fairtex_bgv1.png"},
